  ...
  void initState() {
    ...
    setState(() {
      for (int i = 0; i < widget.otheritem!.length; i++) {
        total = (total +(widget.otheritem!.elementAt(i)['price'] *widget.otheritem!.elementAt(i)['quantity'])) as int;
      }
      if (widget.mealmodel != null) {
        total = (total + (widget.mealmodel!['price'] * widget.quantity)) as int;
      }
    });
    print(now.hour);
    setState(() {
                    ...
                    onPressed: () {
                      if (x <= 0 || x > 16) {
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                          content: Text("Without Time Slot You Cannot Proceed"),
                        ));
                      } else {
                        if (widget.mealmodel == null &&
                            widget.otheritem != null) {
